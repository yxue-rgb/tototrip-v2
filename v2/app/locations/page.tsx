...
function LocationsPageContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a1a13]">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm text-blue-700 font-medium">
                  Click the + button to add a location to your trip
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-2 text-slate-900 dark:text-white">My Locations</h1>
      ...
      <Dialog open={showAddToTripDialog} onOpenChange={setShowAddToTripDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Add Location to Trip</DialogTitle>
            <DialogDescription>
              Add {selectedLocation?.name} to your trip
            </DialogDescription>
          </DialogHeader>
