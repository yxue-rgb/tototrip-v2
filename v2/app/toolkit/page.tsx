    ...
    <div className="min-h-screen bg-white dark:bg-[#0a1a13]">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 glass border-b border-slate-200/50 dark:border-white/10">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          >
            <div className="w-9 h-9 bg-gradient-to-br from-[#E95331] to-[#E7B61B] rounded-xl flex items-center justify-center shadow-lg shadow-red-500/20">
            ...
            {[
              ...
              <a
                ...
                className={`px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${
                  link.active
                    ? "text-[#E95331] bg-red-50/60 dark:bg-red-500/10"
                    : "text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100/60 dark:hover:bg-white/10"
                }`}
              >
                {link.label}
              </a>
            ...
            {user ? (
              <>
                ...
                <div className="hidden md:flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400 px-2">
                  <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#E95331] to-[#E7B61B] flex items-center justify-center">
              ...
              <>
                <Button
                  ...
                  className="hidden md:inline-flex text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white"
                >
                  {t("nav.login")}
                </Button>
                <Button
        ...
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-white/95 dark:bg-[#1A1B2E]/95 backdrop-blur-xl border-b border-slate-200/50 dark:border-white/10 shadow-elevated"
          >
              ...
              {[
                ...
                <a
                  ...
                  className={`block px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 ${
                    link.active
                      ? "text-[#E95331] bg-red-50/50 dark:bg-red-500/10"
                      : "text-slate-700 dark:text-slate-300 hover:text-[#E95331] hover:bg-red-50/50 dark:hover:bg-red-500/10"
                  }`}
                >
                  {link.label}
                </a>
              ...
              {user ? (
                <div className="space-y-1">
                  <button
                    ...
                    className="flex items-center gap-2.5 w-full px-4 py-3 text-sm font-medium text-slate-700 dark:text-slate-300 hover:text-[#E95331] hover:bg-red-50/50 dark:hover:bg-red-500/10 rounded-xl transition-all"
                  >
                    <Plane className="h-4 w-4" />
                    {t("nav.myTrips")}
                  </button>
                  <button
                    ...
                    className="flex items-center gap-2.5 w-full px-4 py-3 text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-white/5 rounded-xl transition-all"
                  >
                    {t("nav.logout")}
                  </button>
                </div>
                ...
                <div className="flex flex-col gap-2 px-4 pt-2 pb-1">
                  <Button
                    ...
                    className="w-full text-sm border-slate-200 dark:border-white/15 dark:text-slate-300"
                  >
                    {t("nav.login")}
                  </Button>
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-[#E95331] to-[#d44a2b] hover:from-[#d63c34] hover:to-[#b12222] text-white shadow-md shadow-red-500/20 border-0 text-sm"
                  >
                    {t("nav.getStarted")}
                  </Button>
                </div>
      ...
      {/* ─── Footer ─── */}
      <footer className="py-16 px-4 bg-[#083022] border-t border-white/5">
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2.5 mb-4">
                <div className="w-9 h-9 bg-gradient-to-br from-[#E95331] to-[#E7B61B] rounded-xl flex items-center justify-center">
