      ...
      <header className="fixed top-0 left-0 right-0 z-50 glass border-b border-[#E0C4BC]/30 dark:border-white/10">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <a href="/toolkit" className="px-3 py-2 text-sm font-medium text-[#083022]/70 dark:text-slate-400 hover:text-[#083022] dark:hover:text-white rounded-lg hover:bg-[#E0C4BC]/20 dark:hover:bg-white/10 transition-all">
              Toolkit
            </a>
          </nav>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="md:hidden p-2 rounded-lg text-[#083022] dark:text-slate-400 hover:bg-[#E0C4BC]/20 dark:hover:bg-white/10 transition-all"
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="container mx-auto px-4 py-4 space-y-1">
              <a href="/" className="block px-4 py-3 text-sm font-medium text-[#083022] dark:text-slate-300 hover:text-[#E95331] rounded-xl transition-all">Home</a>
              <a href="/inspiration" className="block px-4 py-3 text-sm font-medium text-[#083022] dark:text-slate-300 hover:text-[#E95331] rounded-xl transition-all">Inspiration</a>
              <span className="block px-4 py-3 text-sm font-medium text-[#E95331] bg-[#E95331]/10 rounded-xl">Guides</span>
              <a href="/toolkit" className="block px-4 py-3 text-sm font-medium text-[#083022] dark:text-slate-300 hover:text-[#E95331] rounded-xl transition-all">Toolkit</a>
